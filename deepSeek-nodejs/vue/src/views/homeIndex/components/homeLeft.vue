...
import { history } from "@/function/home/deepseekText.js";
</script>
...
<template>
  <div ref="BodyLeft" class="body-left">
    ...
    <div class="body-left-new_token">
      <div class="body-left-new_token_button" @click="newTitle = false">
    ...
    <!--历史信息-->
    <div class="body-left-history">
      <div class="body-left-history-button" v-show="!isBack" :title="his.name" v-for="(his, index) in history" :key="index">
        <div style="overflow: hidden">{{ his.name }}</div>
      </div>
    </div>
    <!--用户设置-->
